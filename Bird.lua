...
--[[
    AABB collision that expects a pipe, which will have an X and Y and 
    reference global pipe width and height values
]]
function Bird:collides(pipe)
    -- the 2s are left and top offsets
    -- the 4s are right and bottom offsets
    -- both offsets are used to shrink the bounding box to give the player
    -- a bit of leeway with the collision
